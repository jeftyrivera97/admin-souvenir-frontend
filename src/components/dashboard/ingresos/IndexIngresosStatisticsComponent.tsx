...
import { AnualMonthlyBarChartComponent, MonthCategoryPieChartComponent, MonthTiposPieChartComponent } from '@/components'
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 grid-rows-1 gap-4">
        <div>
          <MonthCategoryPieChartComponent data={statistics?.categorias ?? []} statistics={statistics} title='Ingresos por Categoria' description='Categorias' />
        </div>
        <div>
          <MonthTiposPieChartComponent data={statistics?.tipos ?? []} statistics={statistics} title='Ingresos por Tipo' description='Tipos' />
        </div>
      ...
      <div className="grid grid-cols-2 grid-rows-1 gap-4">
        <div>
          <IndexCategoriasDataTableComponent categorias={categorias} title='Lista de Categorias' />
        </div>
      ...
      <div className="grid grid-cols-1 grid-rows-1 gap-4">
        <div>
          <AnualMonthlyBarChartComponent data={statistics?.totalsMonths ?? []} statistics={statistics ?? {}} title='Ingresos por Mes' />
        </div>
      </div>
