...
export const IndexEstadisticasSection = ({
    data,
    meta,
}: EstadisticasProps) => {
    ...
    return (
        <>
            <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4 mt-2">
                            ...
                            <Badge variant="outline">
                               {
                                  ...
                                  {data.porcentajeCambioMensual >= 0 ? `+${data.porcentajeCambioMensual}%` : `${data.porcentajeCambioMensual}%`}
                            </Badge>
                        </CardAction>
                    </CardHeader>
                    ...
                    <CardHeader>
                        ...
                        <CardAction>
                            <Badge variant="outline">
                               ...
                               {data.porcentajeCambioAnual >= 0 ? `+${data.porcentajeCambioAnual}%` : `${data.porcentajeCambioAnual}%`}
                            </Badge>
                        </CardAction>
                    </CardHeader>
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                ...
                {/* <Card className="@container/card">
                    <CardHeader>
                        <CardDescription>Registros de Ingresos</CardDescription>
                        <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
                            {data.totalRegistros}
                        </CardTitle>
                        <CardAction>
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        ...
                        <div className="text-muted-foreground">Distribución por categoría</div>
                    </CardFooter>
                </Card> */}
                 ...
                 <Card className="@container/card">
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        ...
                        <div className="text-muted-foreground">Porcentaje de cambio mensual</div>
                    </CardFooter>
                </Card>
                <Card className="@container/card">
                    <CardHeader>
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        ...
                        <div className="text-muted-foreground">Porcentaje de cambio anual</div>
                    </CardFooter>
                </Card>
            </div>
        </>
