...
import type { CategoriaGraphProps, StatisticsGraphProps } from "@/interfaces/Graphs";
export const descripcion = "A pie chart with a label";
const chartConfig = {} satisfies ChartConfig;

interface MonthTiposPieChartProps {
  data?: CategoriaGraphProps;
  title?: string;
  descripcion?: string;
...
export const MonthTiposPieChartComponent = ({
  ...
  descripcion = "Descripción del grafico",
  statistics,
            ...
            {statistics.porcentajeCambioMensual > 0 ? (
              <>
                <span className="text-green-500">
                  En tendencia de subida del{" "}
                  {statistics?.porcentajeCambioMensual}% este mes
                </span>
